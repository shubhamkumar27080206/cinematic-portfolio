...
export const metadata = {
  ...
  title: {
    default: 'Shubham Kumar | Cloud DevOps Engineer',
  ...
  authors: [{ name: 'Shubham Kumar', url: SITE_URL }],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Shubham Kumar| Control-M SME Portfolio',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shubham Kumar | Control-M SME',
    description,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'Shubham Kumar',
              url: SITE_URL,
              email: 'shubhamkumar27080206@gmail.com',
